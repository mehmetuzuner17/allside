        ...
        <div class="row px-xl-5">
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-bordered text-center mb-0">
                    ...
                    <?php $result = getSepet($_SESSION["id"]); while($film = mysqli_fetch_assoc($result)): ?>
                    <tbody class="align-middle">
                        <tr>
                            <td class="align-middle"><img src="img/<?php echo $film["fotografId"] ?>" alt="" style="width: 50px;"> <?php echo $film["urunAd"] ?></td>
                            <td class="align-middle"><?php echo $film["urunUcret"] ?>₺</td>
                            ...
                            <td class="align-middle"><?php echo $film["urunUcret"] ?>₺</td>
                            <td class="align-middle"><button class="btn btn-sm btn-primary" onClick="location.href='urun-delete.php?id=<?= $film["id"] ?>';"><i class="fa fa-times"></i></button></td>
                        </tr>
            ...
            <div class="col-lg-4">
                ...
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        ...
                        <a href="checkout.php" class="btn btn-block btn-primary my-3 py-3">Ödeme Ekranına İlerle </a>
