...
<body>
    ...
    <body>
        <div class="rowfp">
            ...
            <h6 class="information-text">Şifrenizi sıfırlamak için kayıtlı E-Posta'nızı giriniz </h6>
            <div class="form-group">
                <p><label for="username">E-Postanız</label></p>
                <input type="email" name="user_email" id="user_email">
                
                <button onclick="showSpinner()">Şifremi Sıfırla</button>
            </div>
        </div>
    </body>
